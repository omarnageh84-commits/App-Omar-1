const CACHE='app-omar-v20-shortcuts';
const CORE=['./','./index.html?v=20','./daily.html?v=20','./manifest.json?v=20','./icon_192.png','./icon_512.png'];
...
// للاختصارات الخارجية - عند الضغط على إشعار
self.addEventListener('notificationclick', e=>{
  e.notification.close();
  const action = e.action || 'daily';
  let url = './index.html?v=20#'+action;
